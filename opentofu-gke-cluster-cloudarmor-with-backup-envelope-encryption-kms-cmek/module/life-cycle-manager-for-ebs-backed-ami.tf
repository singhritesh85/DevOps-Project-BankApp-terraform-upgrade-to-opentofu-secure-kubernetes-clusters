...
resource "aws_dlm_lifecycle_policy" "ami_lifecycle" {
  description        = "DLM lifecycle policy for EBS backed AMI"
  ...
  tags = {
    Name = "lifecycle-policy-ebs-backed-ami-${var.env}"
  }
}
